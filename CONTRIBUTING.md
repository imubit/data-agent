...
Welcome to `data-agent` contributor's guide.
...
If you experience bugs or general issues with `data-agent`, please have a look
...
You can help improve `data-agent` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`data-agent` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `data-agent`'s files. While this mechanism can
...
```
conda create -n data-agent python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/data-agent.git
   cd data-agent
   ```
...
5. Install [pre-commit]:
   ...
   `data-agent` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/data-agent
[issue tracker]: https://github.com/<USERNAME>/data-agent/issues
